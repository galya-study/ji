...
# данной темой, поэтому он нашел словарь, в котором указано, 
# как ставятся ударения в словах. К сожалению, в этом словаре 
# присутствуют не все слова. Вася решил, что в словах, которых 
# нет в словаре, он будет считать, что Петя поставил ударения 
...
# как Петя поставил ударение, соответствует одному из приведенных в 
# словаре вариантов, он будет засчитывать это как правильную 
...
# заглавных латинских букв. В каждом слове заглавная ровно одна 
# буква — та, на которую попадает ударение. Слова в словаре 
# расположены в алфавитном порядке. Если есть несколько возможностей 
# расстановки ударения в одном и том же слове, то эти варианты в 
...
# Строка состоит из слов, которые разделяются между собой ровно 
# одним пробелом. Длина каждого слова не превышает 30 символов. 
# Все слова состоят из маленьких и заглавных латинских букв 
# (заглавными обозначены те буквы, над которыми Петя поставил 
# ударение). Петя мог по ошибке в каком-то слове поставить более 
# одного ударения или не поставить ударения вовсе.
# 
